...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    return  abs((player_score//10) - (player_score % 10)) == abs((opponent_score//10) - (opponent_score % 10))
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if player == 0:
            ...
            score = take_turn(num_roll,score1,dice)
            if is_swap(score0+score,score1):
                score0 , score1 = score1, score0 + score
        else:
            num_roll = strategy1(score1,score0)
            score = take_turn(num_roll,score0,dice)
            if is_swap(score0,score1+score):
                score0 , score1 = score1 + score ,score0
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announce(score0, score1):
        ...
        if who == 0 :
            ...
            previous_score = score0
            return announce_highest(0,previous_high, previous_score)
            ...
            previous_score = score1
            return announce_highest(1, previous_high, previous_score)
...
def make_averaged(fn, num_samples=1000):
    ...
    # BEGIN PROBLEM 8
    def ave(*args,**kwargs):
        return  sum([fn(*args,**kwargs) for _ in range(num_samples)])/num_samples
    return ave
    "*** YOUR CODE HERE ***"
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    ave_dice = make_averaged(roll_dice, num_samples)
    ave_dice(1)
    a = [ave_dice(i,**{"dice":dice})for i in range(1,10)]
    #for i in range(10):

    good = max(a)
    #print(good)
    index = a.index(good)
    return  index + 1 #roll_dice(5,make_test_dice(2,1))#ave_dice(1,**{"dice":dice})
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    after = free + score
    if (is_swap(after,opponent_score) and after < opponent_score) or  ((free >= margin) and not is_swap(after,opponent_score)):
